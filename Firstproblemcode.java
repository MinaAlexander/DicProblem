...
public class Firstproblemcode {
    ...
    public static void ValidateNumberOfTrailAndDataTypes() {
        ...
        System.out.print("Enter your Number of throwns : ");
        numberOfthrowns = input.nextLine();

        if (numberOfthrowns != "" && numberOfthrowns.matches("^[0-9]*$")) {
            System.out.println("Number of trails : " + numberOfthrowns);
            ...
            if (inputcharacter != "" && inputcharacter.matches("^[0-9]*$")) {
                if (inputcharacter.length() == Integer.valueOf(numberOfthrowns)) {
                    input.close();
                    ConvertStringTointArray(inputcharacter);
                } else {
                    System.out.println(" Please enter correct Number of  character  ");
                    ValidateNumberOfTrailAndDataTypes();
                }
